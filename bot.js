...
client.on("message", function(message) { if(message.content.includes("What time is it?") { client.message.send(author, "Tis be time for a crusade"); } 
});

client.on("message", function(message) { if(message.content === "Captain Midnight") { client.message.send(author, "gg,you found a Easter egg,now what do you want a trophy?"); }
 });
