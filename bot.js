...
client.on('message', message => {if(message.toLowerCase().includes("fuck".toLowerCase())) { message.delete(1000);  message.channel.send(message.content.slice(2000, message.content.length)); } 
});
