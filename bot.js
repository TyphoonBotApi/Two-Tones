...
client.on('message', message => { if (message.content.includes("fuck")) { message.delete(1000);  message.channel.send(message.content.slice(2000, message.content.length)); } 
});

 client.on('message', message => { if (message.content.includes("dick")) { message.delete(1000);  message.channel.send(message.content.slice(2000, message.content.length)); } 
}); 
